...
namespace CMKZ {
    ...
    //    }
    //    //"XX"则在子节点添加一项
    //    public Tree<T> AddDir(string 路径, T 文件) {
    //        if (路径.Contains("/")) {
    //            return Path(路径.DirName()).AddDir(路径.FileName(), 文件);
    //        } else {
    //            var A = new Tree<T> { IsDir = true, Data = 文件, Name = 路径 };
    //            Children.Add(A);
    //            return A;
    //        }
    //    }
    //    public Tree<T> AddFile(string 路径, T 文件) {
    //        if (路径.Contains("/")) {
    //            return Path(路径.DirName()).AddFile(路径.FileName(), 文件);
    //        } else {
    //            var A = new Tree<T> { IsDir = false, Data = 文件, Name = 路径 };
    //            Children.Add(A);
    //            return A;
    //        }
    //    }
