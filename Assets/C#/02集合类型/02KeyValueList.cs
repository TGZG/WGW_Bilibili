    ...
    public class KeyValueList<TKey, TValue> : List<KeyValue<TKey, TValue>> {
        ...
        public KeyValueList() : base() {
            if (typeof(TKey) == typeof(int)) {
                throw new Exception("KeyValueList的键不可以为int，请使用List");
            }
        }
        ...
        public List<TKey> Keys => this.Select(t => t.Key).ToList();
        public List<TValue> Values => this.Select(t => t.Value).ToList();
        ...
        public List<KeyValue<TKey, TValue>> FindKeys(TKey Y) {
